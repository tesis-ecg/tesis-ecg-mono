...
class AuditEventType(enum.StrEnum):
    ...
    DEVICE_API_KEY_VIEWED = "DEVICE_API_KEY_VIEWED"
    ...
    PATIENT_PASSWORD_RESET = "PATIENT_PASSWORD_RESET"  # nosec B105
    PATIENT_REPORT_CREATED = "PATIENT_REPORT_CREATED"
    STUDY_REPORT_DRAFT_UPDATED = "STUDY_REPORT_DRAFT_UPDATED"
    STUDY_REPORT_FINALIZED = "STUDY_REPORT_FINALIZED"
    STUDY_REPORT_DOWNLOADED = "STUDY_REPORT_DOWNLOADED"
    PUSH_SENT = "PUSH_SENT"
