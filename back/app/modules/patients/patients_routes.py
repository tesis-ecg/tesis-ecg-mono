...
async def get_patient(
    ...
    return await service.get_patient(
        PatientIdInput(doctor_id=current_user.id, patient_id=patient_id), db
    )
...
async def get_patient_studies(
    ...
    return await studies_service.list_patient_studies(
        PatientStudiesInput(doctor_id=current_user.id, patient_id=patient_id), db
    )
...
async def create_patient(
    ...
    return await service.create_patient(
        PatientCreateInput(doctor_id=current_user.id, data=data), db
    )
...
async def update_patient(
    ...
    return await service.update_patient(
        PatientUpdateInput(doctor_id=current_user.id, patient_id=patient_id, data=data), db
    )
